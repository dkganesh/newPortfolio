...
export const Profilecard = () => {
  return (
    <>
        <div className=" dk-profile-card flex flex-col justify-around items-center pb-2">
            <img src={profile} alt="" className=' m-auto p-2 dk-profile-pic mt-2 dk-pulse'/>
            <div className=" dk-profile-card-div text-center mt-3">
                <h1 className="dk-profile-name uppercase text-xl font-bold tracking-widest  mt-2">{profileObject.pname}</h1>
